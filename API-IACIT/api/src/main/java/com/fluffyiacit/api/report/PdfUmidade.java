...
public class PdfUmidade {

    public static ByteArrayInputStream exportarPdfUmidade (List<ViewUmidadeModal> viewUmidadeModals) throws IOException {
        ...
        try {
            ...
            hcell = new PdfPCell(new Phrase("Umidade Relativa Ar", headFont));
            ...
            hcell = new PdfPCell(new Phrase("Umidade Relativa Mín", headFont));
            hcell.setPaddingTop(3.5f);
            hcell.setFixedHeight(40f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            hcell = new PdfPCell(new Phrase("Umidade Relativa Máx", headFont));
            hcell.setPaddingTop(3.5f);
            hcell.setFixedHeight(40f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            for (ViewUmidadeModal viewUmidadeModal : viewUmidadeModals) {
                ...
                cell = new PdfPCell(new Phrase(new SimpleDateFormat("dd/MM/yyyy HH:mm").format(viewUmidadeModal.getDatahoraCaptacao()), fontDataHora));
                ...
                cell = new PdfPCell(new Phrase(viewUmidadeModal.getUmidadeRelativaAr(), font));
                cell.setPaddingTop(4f);
                cell.setFixedHeight(25f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                cell = new PdfPCell(new Phrase(viewUmidadeModal.getUmidadeRelativaMin(), font));
                cell.setPaddingTop(4f);
                cell.setFixedHeight(25f);
                ...
                cell = new PdfPCell(new Phrase(viewUmidadeModal.getUmidadeRelativaMax(), font));
                cell.setPaddingTop(4f);
                cell.setFixedHeight(25f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Paragraph textoEstacao = new Paragraph(new Phrase("Estação " + viewUmidadeModals.get(0).getEstacaoNome()
                    + ", " + "Estado de " + viewUmidadeModals.get(0).getEstacaoEstado(), FontFactory.getFont(
            ...
            Paragraph textoDataHora = new Paragraph(new Phrase("Dados de " + new SimpleDateFormat("dd/MM/yyyy HH:mm")
                    .format(viewUmidadeModals.get(0).getDatahoraCaptacao()) + " até " +
                    new SimpleDateFormat("dd/MM/yyyy HH:mm").format(viewUmidadeModals
                            .get(viewUmidadeModals.size() - 1).getDatahoraCaptacao()),
                    FontFactory.getFont(FontFactory.HELVETICA, 21, BaseColor.BLACK)));
            textoDataHora.setAlignment(Element.ALIGN_LEFT);

            Paragraph textoDados = new Paragraph(new Phrase("Umidade", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18, BaseColor.BLACK)));
