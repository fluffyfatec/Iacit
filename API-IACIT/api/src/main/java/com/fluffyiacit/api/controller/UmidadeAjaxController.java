...
//
//
//		if (!umidaderepository.dataLimite(Timestamp.valueOf(filtroModal.getDataHoraInicial()))) {
...
//		}
//
//		if (!umidaderepository.dataLimite(Timestamp.valueOf(filtroModal.getDataHoraFinal()))) {
