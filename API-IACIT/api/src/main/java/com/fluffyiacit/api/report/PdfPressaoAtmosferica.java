...
public class PdfPressaoAtmosferica {

    public static ByteArrayInputStream exportarPdfPressaoAtm (List<ViewPressaoAtmModal> viewPressaoAtmModals) throws IOException {
        ...
        try {
            ...
            hcell = new PdfPCell(new Phrase("Pressão Atm Estação", headFont));
            ...
            hcell = new PdfPCell(new Phrase("Pressão Atm Mínima", headFont));
            hcell.setPaddingTop(3.5f);
            hcell.setFixedHeight(40f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            hcell = new PdfPCell(new Phrase("Pressão Atm Máxima", headFont));
            hcell.setPaddingTop(3.5f);
            hcell.setFixedHeight(40f);
            hcell.setVerticalAlignment(Element.ALIGN_CENTER);
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            for (ViewPressaoAtmModal viewPressaoAtmModal : viewPressaoAtmModals) {
                ...
                cell = new PdfPCell(new Phrase(new SimpleDateFormat("dd/MM/yyyy HH:mm").format(viewPressaoAtmModal.getDatahoraCaptacao()), fontDataHora));
                ...
                cell = new PdfPCell(new Phrase(viewPressaoAtmModal.getPressaoAtmEstacao(), font));
                cell.setPaddingTop(4f);
                cell.setFixedHeight(25f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
                ...
                cell = new PdfPCell(new Phrase(viewPressaoAtmModal.getPressaoAtmMin(), font));
                cell.setPaddingTop(4f);
                cell.setFixedHeight(25f);
                ...
                cell = new PdfPCell(new Phrase(viewPressaoAtmModal.getPressaoAtmMax(), font));
                cell.setPaddingTop(4f);
                cell.setFixedHeight(25f);
                cell.setVerticalAlignment(Element.ALIGN_CENTER);
                cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            ...
            Paragraph textoEstacao = new Paragraph(new Phrase("Estação " + viewPressaoAtmModals.get(0).getEstacaoNome()
                    + ", " + "Estado de " + viewPressaoAtmModals.get(0).getEstacaoEstado(), FontFactory.getFont(
            ...
            Paragraph textoDataHora = new Paragraph(new Phrase("Dados de " + new SimpleDateFormat("dd/MM/yyyy HH:mm")
                    .format(viewPressaoAtmModals.get(0).getDatahoraCaptacao()) + " até " +
                    new SimpleDateFormat("dd/MM/yyyy HH:mm").format(viewPressaoAtmModals
                            .get(viewPressaoAtmModals.size() - 1).getDatahoraCaptacao()),
                    FontFactory.getFont(FontFactory.HELVETICA, 21, BaseColor.BLACK)));
            textoDataHora.setAlignment(Element.ALIGN_LEFT);

            Paragraph textoDados = new Paragraph(new Phrase("Pressão Atmosférica", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18, BaseColor.BLACK)));
