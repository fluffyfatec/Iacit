...
public class HomeController {
	...
	public ModelAndView PaginaIndex() {
		...
		// Lista Precipitacao
		List<ViewPrecipitacaoModal> teste_precipitacao = precipitacao.listar("SP", "SAO PAULO - INTERLAGOS", Timestamp.valueOf("2022-06-28 10:00:00"));
		...
		// Lista Precipitacao
		List<ViewPressaoAtmModal> teste_atm = pressao.listar("SP", "SAO PAULO - INTERLAGOS", Timestamp.valueOf("2022-06-28 10:00:00"));
		...
		// Lista Radiacao
		List<ViewRadiacaoglobalModal> teste_radiacaoglobal = radiacao.listar("SP", "SAO PAULO - INTERLAGOS", Timestamp.valueOf("2022-06-28 10:00:00"));
		...
		// Lista Temperatura
		List<ViewTemperaturaModal> teste_temperatura = temperatura.listar("SP", "SAO PAULO - INTERLAGOS", Timestamp.valueOf("2022-06-28 10:00:00"));
		...
		// Lista Umidade
		List<ViewUmidadeModal> teste_umidade = umidade.listar("SP", "SAO PAULO - INTERLAGOS", Timestamp.valueOf("2022-06-28 10:00:00"));
		...
		// Lista Vento
		List<ViewVentoModal> teste_vento = vento.listar("SP", "SAO PAULO - INTERLAGOS", Timestamp.valueOf("2022-06-28 10:00:00"));
	...
	public ModelAndView PaginaIndexFiltrada(FiltroModal filtromodal) {
		...
		// Lista Precipitacao
		List<ViewPrecipitacaoModal> teste_precipitacao = precipitacao.listar(filtromodal.getEstacao_nome(), filtromodal.getEstacao_estado(), Timestamp.valueOf(filtromodal.getDatahora_captacao()));
		for (ViewPrecipitacaoModal objviewPrecipitacao:teste_precipitacao) {
			if (objviewPrecipitacao.getPrecipitacaototal() == null) {
				objviewPrecipitacao.setPrecipitacaototal("N/A");
			}
