...
public interface VentoRepository extends JpaRepository<ViewVentoModal, String> {
	...
	//LISTA 1 DIA
	@Query ("SELECT pa FROM view_vento_dados pa WHERE pa.estacaoEstado = :estacaoEstado AND pa.estacaoNome = :estacaoNome AND pa.datahoraCaptacao = :datahoraCaptacao")
	public List<ViewVentoModal> listUnica(@Param("estacaoEstado") String estacaoEstado,
    ...
    public List<ViewVentoModal> listRange(@Param("estacaoEstado") String estacaoEstado, 
									      @Param("estacaoNome") String estacaoNome,
